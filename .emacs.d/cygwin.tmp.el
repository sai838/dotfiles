...
;; @ ime
   ...
   (setq load-path (append
		 '("/app/emacs/emacs/lisp/international/")
		 load-path))
   (load "w32-ime.el")
...
;; @ hiwin-mode
   ;; file load
   (setq load-path (append
		 '("/app/emacs/site-lisp/hiwin-mode/")
		 load-path))
   (require 'hiwin)
...
;; @ tabbar
   (setq load-path (append
   		 '("/app/emacs/site-lisp/tabbar"
		   "/app/emacs/emacs/lisp")
   		 load-path))
   (load "mwheel.el")
   (require 'tabbar)
...
;; @ setup-cygwin
   (setq load-path (append
   		 '("/app/emacs/site-lisp/setup-cygwin"
		   "/app/emacs/site-lisp/cygwin-mount")
   		 load-path))
