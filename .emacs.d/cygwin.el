...
;; @ migemo/cmigemo
   ...
   ;; 		 '("/app/emacs/site-lisp/migemo")
   ;; 		 load-path))
   ;; (require 'migemo)
   ;; (setq migemo-command "cmigemo")
   ;; (setq migemo-options '("-q" "-e"))
   ;; (setq migemo-dictionary (getenv "MIGDICT"))
...
(setq load-path (append
		 '("~/dotfiles/.emacs.d/")
		 '("~/dotfiles/.emacs.d/elisp/")
                 load-path))

(load "~/dotfiles/.emacs.d/color.el")
(load "~/dotfiles/.emacs.d/complete.el")
(load "~/dotfiles/.emacs.d/default.el")
